...
import com.example.newsapp.action.DialogAction;
import com.example.newsapp.action.DialogType;
import com.example.newsapp.listener.DialogActionListener;

import java.net.URISyntaxException;


public class CustomDialog implements Info {
    ...
    public static void showGeneralDialog(Context context, String title, String msg, DialogType type,
        ...
        builder.setMessage(msg)
                ...
                .setPositiveButton("Go offline", (dialog, which) -> {
                    dialog.dismiss();
                    // TODO: SEND BROAD_CAST

                    Intent intent = new Intent();
                    intent.setAction(OFFLINE_BUTTON_PRESSED);
    ...
    public void setOnItemClickListener(DialogActionListener dialogActionListener){
